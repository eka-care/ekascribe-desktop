...
internal sealed class ErrorOverlayViewModel : INotifyPropertyChanged
{
    ...
    public ErrorOverlayViewModel()
    {
        ...
        ViewCommand = new RelayCommand(() => ViewRequested?.Invoke(this, EventArgs.Empty));
    }
